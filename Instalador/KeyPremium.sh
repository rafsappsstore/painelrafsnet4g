...
wget  https://github.com/rafsappsstore/painelrafsnet4g/raw/Instalador/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget  https://github.com/rafsappsstore/painelrafsnet4g/raw/Instalador/verifatt.sh > /dev/null 2>&1
wget  https://github.com/rafsappsstore/painelrafsnet4g/raw/Instalador/verpweb > /dev/null 2>&1
wget  https://github.com/rafsappsstore/painelrafsnet4g/raw/Instalador/verweb > /dev/null 2>&1
...
wget  https://github.com/rafsappsstore/painelrafsnet4g/raw/Instalador/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/Instalador/chave")  &>/dev/null
