...
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/main/Instalador/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/main/Instalador/verpweb > /dev/null 2>&1
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/main/Instalador/verweb > /dev/null 2>&1
...
wget  https://raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/main/Instalador/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/rafsappsstore/painelrafsnet4g/main/Instalador/chave") &>/dev/null
